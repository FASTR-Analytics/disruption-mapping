...
indicator_labels_fr <- data.frame(
  ...
  indicator_name = c(
    ...
    "Naissances Vivantes Institutionnels Mises au sein immediatement",
    ...
    "Total de femmes utilisateurs de PF 15-24 ans",
    "Total de femmes utilisateurs de PF 25ans et plus",
    ...
    "Accouchements instututionnels- adolescents",
